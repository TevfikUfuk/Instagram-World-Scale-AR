namespace Mapbox.Unity.Ar
{
	...
	public class SimpleAutomaticSynchronizationContextBehaviour : MonoBehaviour, ISynchronizationContext
	{
		...
		public InstructionObject firstTarget;
		...
		public void GPS()
		{
			...
			if (step == 0)
			{
				...
				InstructionCanvas.Instance.SetInstruction(takingGps);
			...
			if (step == 1)
			{
				...
				if (location.IsLocationUpdated)
				{
					...
					else
					{
						...
						InstructionCanvas.Instance.SetInstruction(secondTarget);
			...
			else if (step == 3)
			{
				...
				if (location.IsLocationUpdated)
				{
					...
					else
					{
						...
						//End of calibration
						InstructionCanvas.Instance.SetInstruction(endofCalibration);
						InstructionCanvas.Instance.SetButtonActive();
